...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_case_studies_business_unit" AS ENUM('bu1', 'bu2');
  CREATE TYPE "public"."enum_team_members_location" AS ENUM('puchheim', 'muenchen', 'budapest');
  CREATE TYPE "public"."enum_posts_category" AS ENUM('architecture', 'development', 'management');
  CREATE TYPE "public"."enum_posts_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__posts_v_version_category" AS ENUM('architecture', 'development', 'management');
  ...
  CREATE TABLE "case_studies" (
  	...
  	"business_unit" "enum_case_studies_business_unit" NOT NULL,
  	"partner_agency" varchar,
  	"logo_id" integer,
  	"approved_for_publishing" boolean DEFAULT false,
  ...
  CREATE TABLE "team_members" (
  	...
  	"photo_id" integer,
  	"location" "enum_team_members_location",
  	"sort_order" numeric DEFAULT 0,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  );
  ...
  CREATE TABLE "site_settings_locations" (
  	...
  	"zip_city" varchar NOT NULL,
  	"phone" varchar NOT NULL
  );
  
  CREATE TABLE "site_settings_locations_locales" (
  	"name" varchar NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  ...
  CREATE TABLE "site_settings" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"email" varchar DEFAULT 'info@maconit.de',
  ...
  ALTER TABLE "testimonials" ADD CONSTRAINT "testimonials_related_case_study_id_case_studies_id_fk" FOREIGN KEY ("related_case_study_id") REFERENCES "public"."case_studies"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "site_settings_locations_locales" ADD CONSTRAINT "site_settings_locations_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."site_settings_locations"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "testimonials_related_case_study_idx" ON "testimonials" USING btree ("related_case_study_id");
  ...
  CREATE UNIQUE INDEX "site_settings_locations_locales_locale_parent_id_unique" ON "site_settings_locations_locales" USING btree ("_locale","_parent_id");`)
}
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "site_settings_locations_locales" CASCADE;
  DROP TABLE "site_settings" CASCADE;
  DROP TYPE "public"."_locales";
  DROP TYPE "public"."enum_case_studies_business_unit";
  DROP TYPE "public"."enum_team_members_location";
