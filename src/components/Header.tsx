  ...
  return (
    <header className="sticky top-0 z-50 border-b border-line bg-white">
      <div className="mx-auto flex h-[76px] max-w-container items-center justify-between px-6">
        ...
        <nav
          className={`fixed inset-x-0 top-[76px] z-40 flex h-[calc(100vh-76px)] flex-col items-stretch gap-0 overflow-y-auto bg-white p-5 transition-transform duration-300 ease-out md:static md:h-auto md:translate-y-0 md:flex-row md:items-center md:gap-0.5 md:bg-transparent md:p-0 md:transition-none ${
